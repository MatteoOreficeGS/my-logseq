	...
	- ## Elencare tutti i client id per cui non esiste una tariffa
		- ```shell
		  grep 'Risposta.*Rate.*15386' /tmp/CtrFatGsped.log | \
		  	...
		  	sort -h | uniq
		  ```
	- ## Mostrare risposte #Model/Object/FattureRate  dal log `CtrFatt.log`
		- ```shell
	...
	- ## Estrarre dal log `CtrFatt.log` solo un'elaborazione
		- ```shell
		  zcat /tmp/CtrFatGsped.log | \
		      ...
		      > 15829.txt
		  ```
	- ## Esaminare log chiamata #Model/Object/FattureRate
		...
		- Inoltre andrebbero #Model/Object/FattureRate