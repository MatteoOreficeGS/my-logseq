...
- # Soluzione ai problemi comuni
  ...
  {{renderer :smartblock, trouble-solution, New Solution ➕, false}}
	- ## Filtrare log selezione di una fascia tariffaria in log `api-yyyy-mm-dd.txt` 
	  ...
	  tags:: [[troubleshooting/solution]], #model/fatturazione/tariffe_fasce, #topic/fascia, #business-rule/calcolo-tariffario, #Instrument/IDE/PHPStorm, #model/fatturazione/tariffe, #Instrument/grep, #topic/servizio, #model/fatturazione/RateComparativa
