- Vai alla guida del tuo processo di [[Process/Tasks Management/GTD/My]]
...
- # Richieste del giorno
	...
	- ## Durante il giorno
		...
		- #### Repo di Business Rules
			...
			- [#A] Molto importante creare un repository di #business-rule #improvements #doc #action/doc
			-
		-
- # Interruzioni
	- PlantUML puó essere utilizzato velocemente per creare #Process/SDC/documentation
		...
		- Creare un #[[doc/howtos]] per uso di #PlantUML #media/diagrams
	- Excalidraw puó essere utilizzato velocemente per creare diagrammi a blocchi o DFD
		- Creare un #[[doc/howtos]] per uso #Excalidraw #media/diagrams