# Attivitá
	- ### NOW Test su calcolaTariffa
	  ...
	  :END:
		...
		- Aggiunta documentazione in working dir PHPStorm API #doc/code #doc/internal #Instrument/php/doc/ArrayShape #Instrument/php/psalm in #[[Progetti/Gsped API/Models/FattureRateModel]]
		  :LOGBOOK:
		...
		- ### Analisi del codice
			...
			- altra cosa che non capisco é quale significato venga dato a `minimo_tassato`, detto diversmente ci sono fasce che non sono di esubero che hanno un `minimo_tassato` diverso da zero ? #[[glossary/minimo tassato]] #action/question
