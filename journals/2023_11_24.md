# Attivitá
	...
	- Chiedo a #people/jhonathan cosa sia **Calcolo automatico nolo immediato** che memorizza il flag `clienti.dhl_controllo_costo` #courier/DHL #business-rule #models/gsped/core/clienti #action/doc/domain
	  :LOGBOOK:
