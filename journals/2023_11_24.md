	...
	- ### Richiesta aiuto #people/diego elaborazione 16018 #client/ubik #courier/PDB #[[Progetti/Motore di Fatturazione]]
	  id:: 656dafd4-f98e-490d-a382-50b6e9d0a406
		...
		- DONE Creato subtask [FT-139|Problema elaborazione 16020](https://gsped.atlassian.net/browse/FT-139) con la issue relativa al cliente #client/ubik
			- ho poi creato una issue dedicata per il bug  [FT-123|Il confronto codice addebito in  `costi_accessori_master` e il codice indicato nella fattura avviene su case diversi](https://gsped.atlassian.net/browse/FT-123)  visto che un #topic/workaround é stato proposto
				- DONE inserire qui riferimenti all PR di fix
				-
		- PR ritirata
			-
