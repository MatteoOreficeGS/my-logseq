			...
			- #### Gestione del lavoro giornaliero
				- Come gestire l'tnterruzioni ? #action/question
					...
					- > mi é successo di dover revisionare #PR, alla mattina appena arrivato analizzo la inbox di github, dopo 1 ora ne arrivano un pandemonio, parliamo di 7-8 #PR, questa di fatto era una interruzione non gestibile facilmente perché :
						- non si poteva sapere quali fossero piú prioritarie,  ovviamente escludendo le hotfix per cui é palese
						- si era giá dedicato del tempo in prima mattina per le notifiche del giorno prima
