			...
			- #### Analisi degli sviluppi collettiva
				...
				- qualsiasi richiesta di variazione in itinere di un task che alteri in qualche modo la lista di attivitá determinate dall'analisi iniziale va necessariamente
					- rianalizzata per determinare quante le variazioni e il loro peso in termini di effort e a quel punto :
						- nel caso in cui l'effort che andasse ad aggiungersi consentisse di stare nello sprint si potrebbe mettere in cantiere nello sprint attuale
						  logseq.order-list-type:: number
							- > sempre e comunque é meglio tracciare questi item come card separate #jira/improvements
