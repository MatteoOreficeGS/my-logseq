		...
		- Mie osservazioni / domande
			- Bisognerebbe fare una distinzione sui processi che stiamo analizzando:
				...
				- ma come monitori il processo **SDC** ?
					- ad oggi ci vorrebbero almeno i passaggi di stato per le card  **TODO / IN CORSO / REVIEW /COMPLETED** , in questa maniera potresti provare a produrre i primi report basandoti sui completamenti delle attivitá
