			...
			- Pair o mobbing programming
				...
				- Alcuni hanno chiesto come gestire e organizzare questi momenti :
					- Va fatto per ogni attivitá a priori oppure in maniera ragionata ? es :
						...
						- sempre e comunque : questo potrebbe bloccare le persone a lungo, é come suddividere la forza lavoro con un divisore pari al numero totale degli sviluppatore, per bilanciare bisognerebbe che a quel punto ci fosse uno switch molto piu rapido tra le varie attivitá e
