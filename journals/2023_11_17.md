	  ...
	  Tags #meeting/dev #Process/SDC #improvements/process #improvements/process
		- ### Argomenti discussi
			- #### #[[Method/Pair Programming]] o #[[Method/Mob Programming]]
				- **Dictat**: Le attivitá di sviluppo dovranno essere fatte in questa modalitá
				- Scetticismo di alcuni a parte solo provando si puó vedere se sia un approccio fattibile, solo li tempo ce lo dirá !
