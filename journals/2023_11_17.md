		...
		- ### Argomenti discussi
			...
			- #### Analisi degli sviluppi collettiva
				...
				- qualsiasi richiesta di variazione in itinere di un task che alteri in qualche modo la lista di attivitá determinate dall'analisi iniziale va necessariamente
					- rianalizzata per determinare quante siano le variazioni, di quale entitá in termini di effort si stia parlando, se facente parte o meno dell'ambito del task attuale #Process/SDC/issue-tracking/risk-assesment e a quel punto :
						- nel caso in cui l'effort che andasse ad aggiungersi consentisse di stare nello sprint lo si potrebbe mettere in cantiere subito
						  logseq.order-list-type:: number
