	  ...
	  Tags #meeting/dev #Process/SDC
		...
		- Mie osservazioni / domande
			- Bisognerebbe fare una distinzione sui processi che stiamo analizzando:
				...
				- ma come monitori il ciclo di vita del #Process/SDC ?
					- ad oggi ci vorrebbero almeno i passaggi di stato **TODO / IN CORSO / REVIEW /COMPLETED** , in questa maniera potresti provare a produrre i primi report basandoti sui completamenti delle attivitá
					- considerare uso di subtask
						- ha diversi vantaggi
							...
							- consente di spezzare il thread di discussione in task jira che hanno id distinto e lavorarle in
						-
