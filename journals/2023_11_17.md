# Attivitá
	- ## Richiesta #people/urso possibilitá inserire listino [[courier/DHL Freight]] #glossary/listino per poi usarlo nella #[[Progetti/Gsped API/Service/Rate Comparativa]]
		...
		- #### ACTIONs
			...
			- Creare una sezione per il miglioramento dei processi, esempio Note Taking in #LogSeq/meta-architecture #improvements/process
			- Creare una sezione per salvare i Trick da nerd, ad esempio le shortcut #LogSeq/meta-architecture
