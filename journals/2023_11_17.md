	  ...
	  Tags #meeting/dev #Process/SDC
		...
		- Mie osservazioni / domande
			- Bisognerebbe fare una distinzione sui processi che stiamo analizzando:
				- una cosa é migliorare il processo di sviluppo : quindi il cosiddetto **software development cycle** detto **SDC**
				- una cosa é migliorare i processi di gsped:
			- ma come monitori il ciclo di vita del proceso di sviluppo  ?
				- ad oggi ci vorrebbero almeno i passaggi di stato TODO/IN CORSO/REVIEW/COMPLETED, in questa maniera potresti avere intanto informazioni sulle prestazioni dei teams in #jira
				- considerare uso di subtask, ha diversi vantaggi
