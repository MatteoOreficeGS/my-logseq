	  ...
	  **Tags**: #meeting/dev #Process/SDC #improvements/process #improvements/jira
		- ### Argomenti discussi
			...
			- #### Analisi degli sviluppi collettiva
				...
				- qualsiasi richiesta di variazione in itinere di un task che si discosti dall'analisi iniziale va necessariamente
					- rianalizzata per determinare se inserirla nello sprint
					- creare una
