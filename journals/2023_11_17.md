		...
		- ### Argomenti discussi
			...
			- #### Analisi degli sviluppi collettiva
				...
				- qualsiasi richiesta di variazione in itinere di un task che alteri in qualche modo la lista di attivitá determinate dall'analisi iniziale va necessariamente
					- rianalizzata per determinare quante le variazioni e il loro peso in termini di effort
					- nel caso l'effort che andrebbe ad aggiungersi mi consentisse di stare nello sprint si potrebbe reinserirla
					- in ogni caso é meglio tracciare questi item al fine di poter tracciare le variazio #jira/improvements
