	...
	- ### LATER Supporto Priscilla #client/LTC #courier/BRT 
	  tags:: event/task/begin, #topic/daily-journal-task
		...
		- [[2024-01-25 Thursday]]
			...
			- Ho aggiornato il file ((65b01287-5e19-4ace-a26a-63c7b4ae06a2)) aggiungendo una colonna che indica dove finisce il campo nel report e con che come oltre che se fosse un calcolato ![image.png](../assets/image_1706183612125_0.png)
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
