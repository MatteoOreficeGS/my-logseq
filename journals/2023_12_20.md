...
- # Attivitá
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### NOW Portare a termine approvazione PR 307
		  ...
		  collapsed:: true
			...
			- devo studiare doc su permessi nel controller https://app.gitbook.com/o/-LhpbdRCZplUyqAg775u/s/-Mi_rXbXjBv4cNL-NNCE/strumenti-utili/autenticazione/legacy#authenticableinterface per il controller che serve la logica batch
			  tags:: #[[Progetti/Gsped Legacy]], #[[Models/Object Model/Object/RestController]], #topic/batch
				- ok fatto alla fine ho inserito in `accessGuardian` la regola per #model/fatturazione/RateComparativa in `awsCli`
		...
		- [[2024-01-09 Tuesday]]
		  ...
		  :END:
			...
			- Ho creato lo script https://gist.github.com/MatteoOreficeGS/dec545d6028f8e97407419d384cfde1d
				- per un insieme di istanze, corrieri e scope recupera i trasporti e li usa per ripetere le chiamate alla #model/fatturazione/RateComparativa 
				  ```php
				  $job = [
