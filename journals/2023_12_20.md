	  ...
	  :END:
		...
		- [[2023-12-27 Wednesday]]
			...
			- #### Problemi ancora presenti
				- DONE Per #courier/DHL il `servizio` viene passato alla rate e in base a opzioni import / export puó essere usato un diverso account nella richiesta
				  :LOGBOOK:
		...
		- [[2023-12-28 Thursday]]
			- LATER come si chiama la vista che mostra la rate comparativa ?
