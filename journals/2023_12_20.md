		...
		- [[2024-01-04 Thursday]]
		  collapsed:: true
			...
			- NOW Completare Tabella di veritá per direzione import export o nazionale **ideale** con aiuto di #people/fabio-alessio #Jira/i/PS22-334 
			  ...
			  :END:
				- |Client Id Country|Sender Country|Recipient Country|Courier|Contesto|
				  |--|--|--|--|--|
				  |IT|IT|IT|*|nazionale|
				  |IT|FR|FR|*|nazionale|
				  |IT|FR|IT|*|import|
				  ...
				  |IT|SM|IT|differenze|import o nazionale ?|
				  |IT|IT|SM|differenze|export o nazionale ?|
				  |SM|SM|IT|differenze|export o nazionale ?|
				  |SM|IT|SM|differenze|import o nazionale ?|
				  |SM|SM|SM|*|nazionale
				  |SM|IT|IT|*|nazionale
