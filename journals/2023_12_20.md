	  ...
	  :END:
		...
		- [[2024-02-28 Wednesday]]
			- dopo un bel po' di tempo faccio merge di canary in api e verifico il merge
				- Ho trovato un problema per metodo `nextWorkingDay` che é stato migliorato da #people/ricci ma non corretto, io lo avevo giá sistemato #issue/bug #issue/vcs/merge-conflict
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
