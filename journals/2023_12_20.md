  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### NOW Fare revisione PR 307
	  ...
	  :END:
		...
		- [[2023-12-28 Thursday]]
			- LATER come si chiama la vista che mostra la #model/fatturazione/RateComparativa ? #Instrument/MVC/View
				- La view é `legacy/application/views/gsped20/crea_spedizione.php`
				- il file #Instrument/Javascript che implementa la logica é ```
				  js/gsped20/crea_spedizione.js`
