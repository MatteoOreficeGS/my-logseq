  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### NOW Fare revisione PR 307
	  ...
	  :END:
		...
		- [[2023-12-28 Thursday]]
			- LATER come si chiama la vista che mostra la #model/fatturazione/RateComparativa ? per poter stabilire dei defaults sensati per la funzione `doRate` é necessario capire se la view che mostra 
			  tags:: #Instrument/MVC/View, #doc/design, #doc/code, #model/fatturazione/RateComparativa
				...
				- la funzione `rateComparativaElaboraArray` formatta output
					- il #topic/tempo-transito viene considerato se `boolean true`
