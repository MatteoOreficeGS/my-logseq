			...
			- DONE documentare formato dei codici contratto #courier/DHL non é documentato , documentare ! #action/doc
			  ...
			  tags:: #topic/courier-logic, #issue/information/missing, #model/core/codici_cliente, #issue/doc/missing, #topic/GUI, #[[Progetti/Gsped Legacy]], #topic/codice-contratto
				...
				- > Ho documentato nel codice sul metodo `\App\models\DHLModel::codiceClienteExpImp` il formato della colonna `codici_cliente.cliente_corriere`
				  ...
				  tags:: #topic/backus-naur form
					- ```txt
					  <simple-code> ::= <string:alpha-num>
					  <simple-code-or-empty> ::= <simple-code> | ""
					  # Codice cliente mittente export - express
					  <code-express-export> ::= <simple-code-or-empty>
					  # Codice cliente mittente import - express
					  <code-express-import> ::= <simple-code-or-empty>
					  # Codice cliente mittente import - camionistico
					  <code-economy-import> ::= <simple-code-or-empty>
					  # Codice cliente mittente export - camionistico
					  <code-economy-export> ::= <simple-code-or-empty>
					  <composite-code> ::= <code-express-export> "|" <code-express-import> "|" <code-economy-import> "|" <code-economy-export>
					  <account-code> ::= <composite-code> | <simple-code>
					  ```
