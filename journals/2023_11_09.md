		...
		- Priscilla
			- [#A] #client/Stampasi #courier/GLS che giro fa per calcolare il Max Peso Volume [[topic/Massimo tra Peso e Peso Volumetrico]] #business-rule ?
			  ...
			  :END:
				...
				- LATER scoprire come viene trattato il campo #topic/p_tax dal #[[Progetti/Motore di Fatturazione/Mappature]] e altri model  #model/shipment/trasporti #business-rule/calcolo-tariffario #[[topic/peso tassato]] #issue/doc/missing
				  :LOGBOOK:
				  ...
				  :END:
					...
					- LATER fare #action/PR che include #issue/code/refactoring  ,  #branch `refactor_rate_allow_http_query_override` #action/PR al fine di migliorare possibilitá di fare refactoring
