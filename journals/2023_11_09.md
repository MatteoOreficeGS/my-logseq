	...
	- ## Via slack
		- Priscilla
			...
			- ### Problema #unifarco segnalato non aggancia le tariffe
			  ...
			  tags:: #model/fatturazione/tariffe, #model/fatturazione/tariffe_fasce, #resume-task, #courier/fercam, #courier/TNT, #courier/TNT, [[Progetti/Motore di Fatturazione]], #model/fatturazione/file_opener_config, #courier/fercam, #courier/TNT
				- Segnalazione precedente
				  {{embed ((65771537-96fc-4d69-aa39-aea332819789))}}
				- NOW [#A] fare riferimento a questa conversazione del [[2023-11-07 Tuesday]] per #courier/fercam #client/unifarco e verificare come mai non aggancia le tariffe https://gsped.slack.com/archives/D051G6YB5UJ/p1699348026676479 e aggiornare la card JIRA opportuna [FT-100|UNIFARCO: importazione fatture Fercam, TNT e DHL](https://gsped.atlassian.net/browse/FT-100)
