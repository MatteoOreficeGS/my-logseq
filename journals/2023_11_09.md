	...
	- ## Via slack
		- Priscilla
			...
			- ### Problema #unifarco segnalato non aggancia le tariffe
			  ...
			  tags:: #models/gsped/fatturazione/tariffe, #models/gsped/fatturazione/tariffe_fasce, #event/task/resume, #courier/fercam, #courier/TNT, #courier/TNT, [[Progetti/Motore di Fatturazione]], #models/gsped/fatturazione/file_opener_config, #courier/fercam, #courier/TNT
			  collapsed:: true
