		...
		- Priscilla
			- [#A] #client/Stampasi #courier/GLS che giro fa per calcolare il Max Peso Volume [[topic/Massimo tra Peso e Peso Volumetrico]] #business-rule ?
			  ...
			  :END:
				...
				- scoprire come viene trattato il campo `p_tax` dal #[[Progetti/Motore di Fatturazione]] #[[Progetti/Motore di Fatturazione/Mappature]] #model/shipment/trasporti #business-rule/calcolo-tariffario #[[topic/peso tassato]] #issue/missing-doc
				  :LOGBOOK:
