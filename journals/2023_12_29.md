...
- # Attivitá
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	- ### LATER Osservazione a #people/alessio-bracco #people/ballerini e spazio in logseq per miglioramento organizzazione del codice
	...
	- ### LATER Ho parlato con #people/Bosio di processi BPM
	  ...
	  tags:: event/task/begin, #idea💡, #improvements/process
		...
		- intera discussione su https://gsped.slack.com/archives/D0525T2B55E/p1703839262310569
			...
			- uomo di latta: #topic/uomo-di-latta
		- #### Task reference table ↗️
		  query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
