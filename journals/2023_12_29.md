# Stand-Up Topics
	...
	- il metodo `\App\models\DHLgsped::codiceClienteExpImp` per import non tiene conto della nazione del #models/gsped/core/cliend_id diversamente dal metodo `\App\models\FattureRategsped::checkSpedImport`
...
- # Attivitá
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### LATER Documentare prima o poi i vari tipi di model che si incontrano in gsped
	  tags:: event/task/begin, #Models, #models/gsped/codeigniter
