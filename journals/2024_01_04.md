...
- # Attivitá
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	- ### LATER Investigazione performance ecourier fatturazione
	  tags:: event/task/begin, #topic/daily-journal-task, #topic/hard-limit, #topic/soft-limit
		- Scovati 12 task in esecuzione durante il job di fatturazione su #client/ecourier
		  ![image.png](../assets/image_1704364305878_0.png)
		- Aggiungo domanda per [[2024-01-05 Friday]] riguardo a
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
