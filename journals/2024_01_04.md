  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	- ### NOW Priscilla richiede mappatura #client/blumen #courier/PDB
	  ...
	  :END:
		...
		- attenzione al campo p_tax che non sembra essere utile a nulla, verificare che prenda quello corretto per i conteggi
		  vedere la pagina
		  {{embed [[topic/Massimo tra Peso e Peso Volumetrico]]}}
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
