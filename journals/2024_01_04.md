	  ...
	  :END:
		- Scovati 12 task in esecuzione durante il job di fatturazione su #client/ecourier, il limite sta in `application/config/Config.php`
		  ![image.png](../assets/image_1704364305878_0.png)
			...
			- il gruppo scala in funzione di cosa? perché se il problema fosse il db a quel punto il numero di child process FPM potrebbe non accettare piu connessioni o quanto meno non smar
