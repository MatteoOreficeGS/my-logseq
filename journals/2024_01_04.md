  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### NOW Inizio integrazione provider pagamento Ingenico
	  ...
	  :END:
		...
		- [[2024-01-15 Monday]]
			- leggendo la doc https://apireference.connect.worldline-solutions.com/s2sapi/v1/en_US/java/hostedcheckouts/create.html?paymentPlatform=ALL ho visto che al dominio se viene messi in cima il sotto dominio `payment.`
			-
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
