	  ...
	  :END:
		...
		- [[2024-02-16 Friday]]
			- Discussione con #people/ballerini e #people/alessio-bracco su uso improprio del deplloy
				- su testbed ENVIRONMENT é production e non development, quindi lo switch per i test lo devo fare grazie al db cfg #issue/design, #issue/config, quali sono i modi corretti di impostare una condizione di test
			-
		- query-table:: true
		  query-sort-by:: page
