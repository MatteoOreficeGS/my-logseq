		...
		- [[2024-02-27 Tuesday]]
		  collapsed:: true
			...
			- ![image.png](../assets/image_1709023290634_0.png)
				...
				- Abbiamo risolto il problema del css per autofill chrome
				  ![image.png](../assets/image_1709052962410_0.png)
		- [[2024-02-28 Wednesday]]
			- vedere lista issue [excel dal chiudere](https://docs.google.com/spreadsheets/d/18gONMMuCK8-1_a_Lu2pZ_GMFPVBIjxy_1Wt2AA9QQm0/edit?pli=1#gid=0) per tempo
			- ho implementato :
				- Translation sometime result lowercase
				- Footer result DHL Italy |
				  On step 4 no pre select the radio button for pickup or dropoff point
				- Remove radio button between rate square on step 4
				- ANALISYS - check if is possible shrink space between rate squares
			- Test ingenico cancellazione pagamento
				...
				- Ho scritto mail per segnalare il problema e chiedere come accorciare https://mail.google.com/mail/u/0/#sent/FMfcgzGxRwxwzCmclQQlcGKcsPKWcHXq
					- rispondono di usare la pagina failure ma quella é giá impostata e non mi sembra abbia un senso
					  ![image.png](../assets/image_1709192891273_0.png)
				-
			-
				-
		- query-table:: true
