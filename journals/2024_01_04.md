	...
	- ### NOW Priscilla richiede mappatura #client/blumen #courier/PDB
	  ...
	  :END:
		...
		- bisogna creare i vari task in jira ed allacciarsi alla issue originale
			...
			- issee generate [FT-123|Il confronto codice addebito in  `costi_accessori_master` e il codice indicato nella fattura avviene su case diversi](https://gsped.atlassian.net/browse/FT-123)
