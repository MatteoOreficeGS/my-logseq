  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	- ### NOW Priscilla richiede mappatura #client/blumen #courier/PDB
	  ...
	  :END:
		...
		- [[2024-01-05 Friday]] ho fatto la update su aurora con la seguente query [update_pdb_aurora.sql](../assets/update_pdb_aurora_1704446937892_0.sql) qui il backup [update_pdb_backup.sql](../assets/update_pdb_backup_1704446968285_0.sql)
		- query-table:: true
		  collapsed:: true
		  #+BEGIN_QUERY
	...
	- ### NOW Inizio integrazione provider pagamento Ingenico
	  ...
	  tags:: event/task/begin, #topic/daily-journal-task, #jira/i/PS22-412
