  ...
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	...
	- ### NOW Inizio integrazione provider pagamento Ingenico
	  ...
	  :END:
		...
		- [[2024-01-26 Friday]]
		  collapsed:: true
			- LATER Documentare il flag #model/shipment/creazione_postuma
		...
		- [[2024-02-16 Friday]]
			- Discussione con #people/ballerini e #people/alessio-bracco su uso improprio del deplloy
				- su testbed ENVIRONMENT é production e non development, quindi lo switch per i test lo devo fare grazie al db cfg #issue/design, #issue/config, quali sono i modi corretti di impostare una condizione di test oggi ? #issue/deploy
			-
		- query-table:: true
		  query-sort-by:: page
