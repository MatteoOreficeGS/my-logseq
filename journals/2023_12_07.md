						...
						- Sotto-insieme **JIRA**: sono le issue censite in #JIRA
						  > ✅️ **Tutte le issue** sono ora tracciate in #JIRA 1️⃣
							- Sotto-insieme **bugs**: il numero di bugs che viene generato da altre issue
								- > ✅️ i bugs vengono generati e collegati direttamente  2️⃣
							- Sotto-insieme **autonomia**: risolvibili in autonomia
							- Sotto-insieme **ricorrenti**: che si ripresentano nel tempo
								- > ✅️ La risoluzione delle issue  **ricorrenti** attinge da una knowledge base che viene costantemente aggiornata per offrire soluzioni specifiche a problemi simili.
	- # Aiuto compilazione
