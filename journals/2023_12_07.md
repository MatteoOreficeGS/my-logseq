type:: [[LS/Page/Journal]]
	...
	- # Stand-Up Topics
		- Rilevato fallimento di processo su approvazione dell pull request
		  tags:: #topic/pull-request, #issue/failure, #Process/SDC/code-review
			- la mia PR é li in attesa e nessuno la ha guardata....
			- sarebbe il caso che comunque ci fossero delle notifiche
			- sarebbe il caso di poter settare una due date
		- Livello di Log minimo in API ?? coinvolgere anche #people/fabio-alessio 
