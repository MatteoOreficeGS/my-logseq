	...
	- # Stand-Up Topics
	  collapsed:: true
		...
		- Rilevato fallimento di processo su approvazione dell pull request
		  tags:: #topic/pull-request, #issue/failure, #Process/SDC/code-review, #[[Process/Process Managament/Improvement]]
	...
	- # Attivitá
	  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
		...
		- ### LATER Censire osservazioni di #people/casetta
		  tags:: #action/task/update
		  :LOGBOOK:
		  CLOCK: [2023-12-07 Thu 09:44:00]--[2023-12-19 Tue 15:29:07] =>  293:45:07
		  :END:
			- usare card https://gsped.atlassian.net/browse/PS22-342
