...
- # Attivitá
  {{renderer :smartblock, resume-task, Resume Task ⏩️, false}} {{renderer :smartblock, new-task, New Task ➕, false}}
	- ### Riprendo Task problema configurazioni unifarco ⏩️
	  tags:: #resume-task 
	  {{embed (())}}
	- ### Discussione nuovo ambiente con #people/alessio-bracco e #people/ballerini 
	  tags:: #meeting, #topic/devops
		- gsped/php non era stata pushata e non trovata swoole
		- necessario cambiare nel file
- # Aiuto compilazione
  collapsed:: true
