	  ...
	  :END:
		...
		- NOW aggiornare le card tipo analysis in board sviluppo al fine di allineare analisi
		  ...
		  :END:
			...
			- DONE analisi exp imp https://gsped.atlassian.net/wiki/spaces/Sviluppi/pages/1101234183/DHL+metodo+expimp
			- NOW analisi p_tax https://gsped.atlassian.net/browse/PS22-428
			  :LOGBOOK:
