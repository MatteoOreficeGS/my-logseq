...
- # Richieste del giorno
	...
	- ## Via slack
		...
		- **Priscilla**
			...
			- NOW #client/Brumana #courier/TNT  ho riferito di guardare la card [FT-108|Brumana | TNT: verifica support formato internazionale del file allegato](https://gsped.atlassian.net/browse/FT-108)  per ció che ho scritto #[[Progetti/Motore di Fatturazione]]
			  :LOGBOOK:
