	...
	- ## Via slack
		...
		- **Priscilla**
			...
			- #client/Stampasi: ha scritto al corriere per applicazione del giusto calcolo peso o volume?
				...
				-
			- NOW #client/Brumana #courier/TNT  ho riferito di guardare la card [FT-108|Brumana supporto per corriere TNT internazionale su file indicato](https://gsped.atlassian.net/browse/FT-108) #[[Progetti/Motore di Fatturazione]]
			  collapsed:: true
			  :LOGBOOK:
