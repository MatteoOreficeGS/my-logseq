# Attivitá
	...
	- ### DONE Richieste priscilla verifica elaborazione #client/Bonzai
	  ...
	  :END:
		...
		- #### Riga 27
		  TBD
		- Interessante anche il concetto di `last_cons` che permette di gestire ordine di calcolo degli addebiti percentuali #business-rules/calcolo-tariffario #model/fatturazione/costi_accessori_master #model/fatturazione/costi_accessori_local
