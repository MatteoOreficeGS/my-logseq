	  ...
	  id:: 655db840-b7d8-4ed4-9c6d-2d0d948d816b
		...
		- Analizzare chiamate a `FattureRateModel::calcolaSingoloNoloAddebito`
			...
			- DONE SetLowestPrice: vecchio sistema aggiunge anche corriere
			  ...
			  :END:
			- NOW `RateComparativaOnlinestore`: sembra non essere piú utilizzata ma meglio chiedere #action/question
			  :LOGBOOK:
			  CLOCK: [2023-11-28 Tue 17:41:00]
			  :END:
		- Documentare logica che usa la #model/fatturazione/RateComparativa per capire quale `client_id` utilizzare , se invoiced oppure il client normale #action/doc #issue/lack-of-documentation
			- notare che negli `api_field` la validazione controlla la relazione tra client id e accesso per verificare accesso
		- NOW Dobbiamo anche rivedere contenuto di #model/fatturazione/template_zone_corrieri 
		  :LOGBOOK:
		  CLOCK: [2023-11-29 Wed 10:01:41]
		  :END:
			- ![image.png](../assets/image_1701248617323_0.png)
			- zona ITALIA va lasciato o tolto?
		- NOW Ho rilevato un problema in `\App\models\FattureRateModel::calcolaNoliAddebiti` sembra non essere usato  #issue/code #issue/code/refactoring #issue/code/deprecated #action/refactor
		  :LOGBOOK:
		  CLOCK: [2023-11-29 Wed 10:37:45]
		  :END:
	- ### NOW Richieste priscilla verifica elaborazione #client/Bonzai
	  ...
	  :END:
		...
		- #### Riga 27
			- NOW Analizzare problema ultima
			  :LOGBOOK:
			  CLOCK: [2023-11-28 Tue 19:53:05]
			  :END:
		...
		- NOW #people/priscilla mi ha chiesto di variare il formato della mappatura #client/Bonzai #courier/BRT
		  :LOGBOOK:
