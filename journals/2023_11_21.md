	...
	- ### NOW Problema #courier/DHL san marino va visto come internazionale e non nazionale
	  ...
	  :END:
		...
		- [[2023-12-18 Monday]] verifico quali clienti potrebbero avere zone da modificare dopo merge #PR
			...
			- NOW forse sarebbe meglio fare uno script per rilevare le possibili istanze afflitte da problemi ? si potrebbe prendere la palla al balzo per creare un repo utils da usarsi come la shared per le connessioni
			  :LOGBOOK:
